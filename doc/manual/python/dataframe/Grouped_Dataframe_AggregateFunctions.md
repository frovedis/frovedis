...
FrovedisGroupedDataFrame Aggregate Functions - functions related to aggregate operations on grouped dataframe are illustrated here.  
...
### 3. min(numeric_only = True, min_count = -1)  
...
### 6. sum(numeric_only = True, min_count = 0)  
...
- **[Introduction to Frovedis GroupedDataframe](https://github.com/frovedis/frovedis/tree/master/doc/manual/python/dataframe/Grouped_DataFrame_Introduction.md)**  
- **[Introduction to Frovedis Dataframe](https://github.com/frovedis/frovedis/tree/master/doc/manual/python/dataframe/DataFrame_Introduction.md)**  