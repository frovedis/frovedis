...
void do_train(const string& input, 
  ...
  auto lm = linear_svm_regressor<T>().set_solver(solver)
...
int main(int argc, char* argv[]) {
  ...
  opt.add_options()
    ...
    ("loss", value<string>(), 
     "linear svm regression loss type: EPS for epsilon-insensitive (default) or SQEPS for squared-epsilon-insensitive")
