...
po::variables_map parse(int argc, char** argv) {
  ...
  optarg_desc.add_options()
    ...
    ("min-instance", po::value<size_t>()->default_value(1),
     "the minimum number of instances per tree node")
    ("min-infogain", po::value<double>()->default_value(0.0),
