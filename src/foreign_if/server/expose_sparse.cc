...
void expose_frovedis_sparse_matrix_functions() {
  ...
  expose((create_local_crs<int,int,size_t,int,int,long>)); 
  expose((create_local_crs<int,size_t,size_t,int,long,long>)); 
  expose((create_local_crs<long,int,size_t,long,int,long>)); 
  expose((create_local_crs<long,size_t,size_t,long,long,long>)); 
  expose((create_local_crs<float,int,size_t,float,int,long>)); 
  expose((create_local_crs<float,size_t,size_t,float,long,long>)); 
  expose((create_local_crs<double,int,size_t,double,int,long>)); 
  expose((create_local_crs<double,size_t,size_t,double,long,long>)); 
  expose((to_crs_dummy_matrix<DT1,DT4,DT5>));
  expose((to_crs_dummy_matrix<DT1,DT5,DT5>));
  expose((to_crs_dummy_matrix<DT2,DT4,DT5>));
  expose((to_crs_dummy_matrix<DT2,DT5,DT5>));
  expose((to_crs_dummy_matrix<DT3,DT4,DT5>));
  expose((to_crs_dummy_matrix<DT3,DT5,DT5>));
  expose((to_crs_dummy_matrix<DT4,DT4,DT5>));
  expose((to_crs_dummy_matrix<DT4,DT5,DT5>));
