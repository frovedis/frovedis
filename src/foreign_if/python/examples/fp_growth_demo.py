...
'''
#data = pd.read_csv("./input/groceries.csv", dtype=str).drop(['Item(s)'], axis=1)
#print ("Loaded data: ", data.column, data.index)
test_data = data

fpm = FPGrowth(minSupport=0.01, minConfidence=0.5,
