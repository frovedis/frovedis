...
bin/com/nec/frovedis/sql/Expr.class: main/com/nec/frovedis/sql/Expr.scala ${JCLASSES}
	${SCALA_HOME}/bin/scalac -cp "./bin:${SPARK_HOME}/jars/*:${HDPATH}" -sourcepath . -d bin ./main/com/nec/frovedis/sql/Expr.scala
bin/com/nec/frovedis/sql/DFOperator.class: main/com/nec/frovedis/sql/DFOperator.scala ${JCLASSES} bin/com/nec/frovedis/sql/Expr.class
...
bin/com/nec/frovedis/sql/FrovedisColumn.class: main/com/nec/frovedis/sql/FrovedisColumn.scala bin/com/nec/frovedis/sql/Expr.class
	${SCALA_HOME}/bin/scalac -cp "./bin:${SPARK_HOME}/jars/*:${HDPATH}" -sourcepath . -d bin ./main/com/nec/frovedis/sql/FrovedisColumn.scala
bin/com/nec/frovedis/sql/FrovedisAggr.class: main/com/nec/frovedis/sql/FrovedisAggr.scala bin/com/nec/frovedis/sql/FrovedisColumn.class
	${SCALA_HOME}/bin/scalac -cp "./bin:${SPARK_HOME}/jars/*:${HDPATH}" -sourcepath . -d bin ./main/com/nec/frovedis/sql/FrovedisAggr.scala
bin/com/nec/frovedis/sql/FrovedisGroupedDF.class: main/com/nec/frovedis/sql/FrovedisGroupedDF.scala bin/com/nec/frovedis/sql/FrovedisAggr.class bin/com/nec/frovedis/exrpc/FrovedisSparseData.class bin/com/nec/frovedis/sql/DFtoSparseInfo.class bin/com/nec/frovedis/sql/DFOperator.class
