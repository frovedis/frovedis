...
import com.nec.frovedis.mllib.regression.{LinearRegressionWithSGD,LinearRegressionModel}
import org.apache.spark.{SparkConf, SparkContext}
import org.apache.spark.mllib.util.MLUtils
import org.apache.spark.mllib.linalg.Vectors
import org.apache.spark.mllib.regression.LabeledPoint

//OBJECTIVE: To test Frovedis scala wrapper of Linear regression with sgd optimizer for sparse and dense data
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = LinearRegressionWithSGD.train(dense_data)
    val m2 = LinearRegressionWithSGD.train(sparse_data)
