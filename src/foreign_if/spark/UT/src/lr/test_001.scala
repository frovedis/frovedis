...
//OBJECTIVE: To test Frovedis scala wrapper of Logistic regression with sgd optimizer for sparse and dense data
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = LogisticRegressionWithSGD.train(dense_data)
    val m2 = LogisticRegressionWithSGD.train(sparse_data)
  
    // -------- prediction --------
    var tdata = sparse_data.map(_.features) 
