...
import com.nec.frovedis.mllib.classification.{LogisticRegressionWithLBFGS,LogisticRegressionModel}
import org.apache.spark.{SparkConf, SparkContext}
import org.apache.spark.mllib.util.MLUtils
import org.apache.spark.mllib.linalg.Vectors
import org.apache.spark.mllib.regression.LabeledPoint

//OBJECTIVE: To test Frovedis scala wrapper of Linear Logistic regression with lbfgs optimizer for sparse and dense data
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = LogisticRegressionWithLBFGS.train(dense_data)
    val m2 = LogisticRegressionWithLBFGS.train(sparse_data)
