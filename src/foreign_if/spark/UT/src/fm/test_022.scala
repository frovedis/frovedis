...
// Objective : Test train API with data and 5 argument provided
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val f_model = FactorizationMachine.train(data,initStdev = 0.1,iter = 100, stepSize = 0.01,optimizer="SGD", isRegression = true)
