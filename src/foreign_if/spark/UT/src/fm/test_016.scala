...
// Objective : Test train API with data and 7 argument provided
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val f_model = FactorizationMachine.train(data,initStdev = 0.1,iter = 100,learnRate = 0.1,optimizer="SGD", 
                                             isRegression = true, dim = (true, true, 8),regParam = (0.0, 0.0, 0.1))
