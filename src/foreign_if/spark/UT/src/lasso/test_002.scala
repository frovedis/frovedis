...
import com.nec.frovedis.mllib.regression.{LassoWithLBFGS,LinearRegressionModel}
import org.apache.spark.{SparkConf, SparkContext}
import org.apache.spark.mllib.util.MLUtils
import org.apache.spark.mllib.linalg.Vectors
import org.apache.spark.mllib.regression.LabeledPoint

//Objective : To test Frovedis scala wrapper of Lasso regression with sgd optimizer for sparse and dense data
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = LassoWithLBFGS.train(dense_data)
    val m2 = LassoWithLBFGS.train(sparse_data)
