...
// OBJECTIVE: To test Frovedis scala wrapper of DecisionTree.train with 5 parameters
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = DecisionTree.train(data, Classification, Gini, maxDepth, numClasses)
    val m2 = org.apache.spark.mllib.tree.DecisionTree.train(data, Classification, Gini, maxDepth, numClasses)
