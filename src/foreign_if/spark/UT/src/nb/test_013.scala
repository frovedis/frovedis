...
// OBJECTIVE: To test Frovedis scala wrapper of NaiveBayes.train with all input/nb
// model : "bernoulli"
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var s_data = MLUtils.loadLibSVMFile(sc, "./input/nb/bernoulli.txt")

    // -------- training --------
    val fdata = new FrovedisLabeledPoint(s_data)
    val m1 = NaiveBayes.train(fdata,1,"bernoulli")
    val m2 = org.apache.spark.mllib.classification.NaiveBayes.train(s_data,1,"bernoulli")
