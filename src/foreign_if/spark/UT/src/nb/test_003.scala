...
// OBJECTIVE: To test Frovedis scala wrapper of NaiveBayes.train with three input/nbs
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = NaiveBayes.train(data, lambda=0.8, modelType="multinomial")
    val m2 = org.apache.spark.mllib.classification.NaiveBayes.train(data, lambda=0.8, modelType="multinomial")
