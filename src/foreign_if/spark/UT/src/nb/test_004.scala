...
// OBJECTIVE: To test Frovedis scala wrapper of NaiveBayes.train for abnormal lambda data
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      val m1 = NaiveBayes.train(data, lambda = -1.0) // lambda should be positive
    }
    catch {
