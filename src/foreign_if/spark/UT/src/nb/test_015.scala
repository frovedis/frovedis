...
//OBJECTIVE: To test Frovedis scala wrapper of naive bayes for sparse and dense data
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = NaiveBayes.train(dense_data)
    val m2 = NaiveBayes.train(sparse_data)
