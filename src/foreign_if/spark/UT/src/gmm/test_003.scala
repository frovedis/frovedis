...
//OBJECTIVE: To test Frovedis scala wrapper of GaussianMixture with Frovedis row major matrix
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    if(gmm_model.gaussians.length == ncomponents) println("Status: Passed")
