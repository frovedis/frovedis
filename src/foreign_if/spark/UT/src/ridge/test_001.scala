...
//Objective : To test Frovedis scala wrapper of Ridge regression with sgd optimizer for sparse and dense data
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = RidgeRegressionWithSGD.train(dense_data)
    val m2 = RidgeRegressionWithSGD.train(sparse_data)
