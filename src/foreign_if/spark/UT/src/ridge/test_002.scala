...
// OBJECTIVE: To test Frovedis scala wrapper of Ridge regression with lbfgs optimizer for sparse and dense data
...
object GenericTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // -------- training --------
    val m1 = RidgeRegressionWithLBFGS.train(dense_data)
    val m2 = RidgeRegressionWithLBFGS.train(sparse_data)
