...
// OBJECTIVE: Testing Frovedis scala wrapper function eigsh(),member of EigenValueDecomposition singleton object with RDD Dense data
...
object GenericTest {
  def main(args: Array[String]): Unit = {
    ...
    try{
      val res = EigenValueDecomposition.eigsh(rows, k = 3, sigma = 1.0f, tol = 1e-10, 
