...
// OBJECTIVE: Testing Frovedis scala wrapper function eigsh(), a member of RowMatrixUtils singleton object with RowMatrix data
...
object GenericTest {
  def main(args: Array[String]): Unit = {
    ...
    try{
      val res = RowMatrixUtils.eigsh(mat, k = 3)
