...
//OBJECTIVE: Testing Frovedis scala wrapper function eigshUsingFrovedis(), member of RowMatrixUtils singleton object with RowMatrix data
...
object GenericTest {
  def main(args: Array[String]): Unit = {
    ...
    try{
      val res = mat.eigshUsingFrovedis(3)
