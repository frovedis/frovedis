...
// OBJECTIVE: Testing Frovedis scala wrapper function eigsh(),a member of EigenValueDecomposition singleton object with RDD Sparse data
...
object GenericTest {
  def main(args: Array[String]): Unit = {
    ...
    try{
      val res = EigenValueDecomposition.eigsh(rows, k = 3, sigma = 0.0f, tol = 1e-10, 
