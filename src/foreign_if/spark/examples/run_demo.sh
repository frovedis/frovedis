...
echo -e "\n --- executing frovedis evd demo ---"
spark-submit --driver-java-options "-Djava.library.path=$LIBRARY_PATH" --jars $JARS --conf spark.driver.memory=8g lib/spark2frovedis_evd.jar "$COMMAND"
