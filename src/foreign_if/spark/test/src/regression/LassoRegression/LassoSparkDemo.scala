package test.regression.LassoRegression;
...
object LassoSparkDemo {
  def main(args: Array[String]): Unit = {
    ...
    // -------- configurations --------
    val conf = new SparkConf().setAppName("LassoSpark") 
    ...
    if (opt == "sgd") {
      val m1 = LassoWithSGD.train(training,numiter,stepsize,regp,mb)
      ...
      throw new IllegalArgumentException("Spark doesn't support LassoWithLBFGS.");
    }
