...
typed_dfcolumn<int>::filter_gt(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<int>::filter_gt_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<unsigned int>::filter_gt(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<unsigned int>::filter_gt_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<long>::filter_gt(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<long>::filter_gt_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<unsigned long>::filter_gt(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<unsigned long>::filter_gt_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<float>::filter_gt(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<float>::filter_gt_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<double>::filter_gt(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<double>::filter_gt_immed(std::shared_ptr<dfscalar>& right);
