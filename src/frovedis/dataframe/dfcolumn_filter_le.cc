...
typed_dfcolumn<int>::filter_le(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<int>::filter_le_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<unsigned int>::filter_le(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<unsigned int>::filter_le_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<long>::filter_le(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<long>::filter_le_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<unsigned long>::filter_le(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<unsigned long>::filter_le_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<float>::filter_le(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<float>::filter_le_immed(std::shared_ptr<dfscalar>& right);

template node_local<std::vector<size_t>>
typed_dfcolumn<double>::filter_le(std::shared_ptr<dfcolumn>& right);
template node_local<std::vector<size_t>>
typed_dfcolumn<double>::filter_le_immed(std::shared_ptr<dfscalar>& right);
