...
dftable dftable_base::make_sliced_dftable(size_t st, size_t end, size_t step) {
  ...
  return filtered_dftable(*this, std::move(idx)).select(columns());
}
